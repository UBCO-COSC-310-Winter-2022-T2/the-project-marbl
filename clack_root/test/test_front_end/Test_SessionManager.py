...
def test_get_existing_session():
    ...
    SM.existingSession = Session(Mock(), Mock(),Mock(),Mock(),Mock(),Mock())
    assert SM.get_existing_session() != None
